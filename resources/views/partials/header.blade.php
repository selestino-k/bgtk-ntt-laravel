...
<header class="fixed top-0 left-0 right-0 z-30 w-full py-2 bg-white/85 backdrop-blur-sm shadow-sm">
    <div class="flex h-16 max-w-screen items-center xl:justify-between px-4">
        ...
        <div class="hidden xl:flex items-center gap-4">
            <img src="/images/assets/ramah-ori.png" alt="Kemendikdasmen Ramah" class="h-12 w-auto"
                onerror="this.style.display='none'">
            <img src="/images/assets/pendidikan-bermutu-ori.png" alt="Pendidikan Bermutu" class="h-12 w-auto"
                onerror="this.style.display='none'">
        </div>
