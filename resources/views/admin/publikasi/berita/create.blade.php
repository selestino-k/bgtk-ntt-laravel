...
@section('content')
    <div class="p-6 md:p-8 font-montserrat">
        ...
        <div class="card border border-base-300 shadow-sm bg-base-100">
            <div class="card-body">
                <form action="{{ route('admin.publikasi.berita.store') }}" method="POST" enctype="multipart/form-data"
                    class="space-y-5">
                    @csrf
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" id="gambar-url" name="gambar" value="{{ old('gambar') }}"
                            placeholder="URL gambar" class="input input-bordered w-full" />
                        <input type="file" id="gambar-file" name="gambar_file" accept="image/*"
                        ...
                        <div id="gambar-preview-wrapper" class="mt-3 hidden">
                            ...
                            <img id="gambar-preview" src="" alt="Pratinjau"
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="dokumen_url" value="{{ old('dokumen_url') }}"
                            placeholder="Masukkan URL dokumen" class="input input-bordered w-full" />
                        @error('dokumen_url')
                            <p class="mt-1 text-sm text-error">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-control">
                        <label class="label cursor-pointer justify-start gap-3">
                            <input type="checkbox" name="published" value="1"
                                {{ old('published') ? 'checked' : '' }} class="checkbox checkbox-success" />
