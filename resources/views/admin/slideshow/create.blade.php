...
<div class="p-6 md:p-8 font-montserrat">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <h1 class="text-3xl sm:text-4xl font-bold text-primary">Tambah Slide</h1>
        </div>
    ...
    <div class="card border border-base-300 shadow-sm bg-base-100">
        <div class="card-body">
            <form action="{{ route('admin.slideshow.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                @csrf

                {{-- Gambar --}}
                <div class="form-control">
                    <label class="label"><span class="label-text font-medium">Gambar <span class="text-error">*</span></span></label>
                ...
                <div class="form-control">
                    ...
                    <textarea name="deskripsi" rows="3"
                              ...
                              placeholder="Teks caption yang tampil di bawah slide">{{ old('deskripsi') }}</textarea>
