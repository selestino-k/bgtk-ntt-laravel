    ...
    <div class="flex h-16 max-w-screen items-center xl:justify-between px-4">
        ...
        <nav class="hidden xl:flex items-center font-montserrat font-semibold text-primary gap-6">
            ...
            <div class="dropdown">
                ...
                <ul tabindex="0"
                    class="dropdown-content menu bg-white/90 dark:bg-black/90 backdrop-blur-sm rounded-box z-10 w-52 p-2 shadow-xl border border-base-200">
                    <li><a href="/publikasi/berita-terkini"
                            class="text-sm font-medium text-black dark:text-white hover:text-primary hover:bg-gray-700/10">Berita
                            Terkini</a></li>
            ...
            <div class="dropdown">
                ...
                <ul tabindex="0"
                    class="dropdown-content menu bg-white/90 dark:bg-black/90 backdrop-blur-sm rounded-box z-10 w-56 p-2 shadow-xl border border-base-200">
                    <li><a href="/ult/sarana-prasarana"
                            class="text-sm font-medium text-black dark:text-white hover:text-primary hover:bg-gray-700/10">Sarana
                            dan Prasarana</a></li>
                    <li><a href="https://s.id/ult-bgtkntt" target="_blank" rel="noopener noreferrer"
                            class="text-sm font-medium text-black dark:text-white hover:text-primary hover:bg-gray-700/10">Survei
                            Kepuasan Masyarakat (SKM)</a></li>
                    <li><a href="https://prod.lapor.go.id/" target="_blank" rel="noopener noreferrer"
                            class="text-sm font-medium text-black dark:text-white hover:text-primary hover:bg-gray-700/10">SP4N
                            Lapor</a></li>
                    <li><a href="https://wbs.kemendikdasmen.go.id/" target="_blank" rel="noopener noreferrer"
                            class="text-sm font-medium text-black dark:text-white hover:text-primary hover:bg-gray-700/10">WBS
                            Itjen</a></li>
                    <li><a href="https://posko-pengaduan.itjen.kemendikdasmen.go.id/" target="_blank"
                            rel="noopener noreferrer"
                            class="text-sm font-medium text-black dark:text-white hover:text-primary hover:bg-gray-700/10">Aduan
                            Itjen</a></li>
                    <li><a href="https://sippn.menpan.go.id/" target="_blank" rel="noopener noreferrer"
                            class="text-sm font-medium text-black dark:text-white hover:text-primary hover:bg-gray-700/10">SIPPN</a>
                    </li>
                </ul>
            </div>
            ...
            {{-- PPID --}}
            <a href="/ppid"
                class="btn btn-ghost btn-sm text-sm text-primary font-semibold hover:text-primary/70 transition-colors">PPID</a>
            ...
            {{-- SSD --}}
            <a href="/ssd"
                class="btn btn-ghost btn-sm text-sm text-primary font-semibold hover:text-primary/70 transition-colors">SSD</a>
